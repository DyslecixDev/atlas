...
import { type Entry, isCurrentChapter } from "@/lib/sections";

/**
 * Full reading page for one entry, shared by parts (/parts/[id]) and appendices
 * (/appendices/[id]) since they render identically.
 */
